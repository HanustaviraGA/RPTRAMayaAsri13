...
?>
            ...
            <div class="col">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary float-left">Topik</h6>
                                    ...
                                    <tr role=" row" class="odd">
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-sm del" data-nama="<?=$data['nama']?>"
                                                data-id="<?= $data['id_topik'] ?>">Delete</a>
                                            <a href="ubah.php?id_topik=<?= $data['id_topik'] ?>"
    ...
    <script>
        $(".del").on("click", function () {
            ...
            swal({
                title: "Anda yakin ?",
                text: "Apa anda yakin ingin menghapus topik \n\"" + nama + "\"",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            }).then((willDelete) => {
                if (willDelete) {
                    window.location.href = 'controller.php?id_topik=' + id + '&aksi=hapus';
                }
            });
        })
    </script>
