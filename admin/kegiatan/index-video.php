...
?>
            ...
            <div class="col">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary float-left">Video</h6>
                        <a href="tambah-video.php" class="btn btn-primary float-right btn-md">Tambah</a>
                    </div>
                    <div class="card-body">
                                            ...
                                            <div class="btn-toolbar justify-content-between" role="toolbar"
                                                ...
                                                <div class="btn-group" role="group" aria-label="First group">
                                                    <a class="btn btn-danger btn-sm del" data-nama="<?=$data['judul']?>"
                                                        data-id="<?= $data['id_video'] ?>"
                                                        data-video="<?=$data['video']?>">Delete</a>
                                                    <a href="detail-video.php?id_video=<?= $data['id_video'] ?>"
                                                        class="btn btn-info btn-sm">Detail</a>
                                                    <a href="ubah-video.php?id_video=<?= $data['id_video'] ?>"
                                                        class="btn btn-warning btn-sm">Edit</a>
                                                    <?php  if($data['status'] == 1): ?>
                                                    <a href="controller-video.php?id_video=<?= $data['id_video'] ?>&status=<?= $data['status'] ?>&aksi=status"
    ...
    <script>
        ...
        swal({
            title: "Anda yakin ?",
            text: "Apa anda yakin ingin menghapus video \n\"" + nama + "\"",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        }).then((willDelete) => {
            if (willDelete) {
                window.location.href = 'controller-video.php?id_video=' + id + '&video=' + video +
                    '&aksi=hapus';
            }
        });
    })
