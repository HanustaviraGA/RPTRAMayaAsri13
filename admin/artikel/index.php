        ...
        <div class="col">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary float-left">Artikel</h6>
                                        ...
                                        <div class="btn-toolbar justify-content-between" role="toolbar"
                                            ...
                                            <div class="btn-group" role="group" aria-label="First group">
                                                <a class="btn btn-danger btn-sm del" data-nama="<?=$data['judul']?>"
                                                    data-id="<?= $data['id_artikel'] ?>"
                                                    data-img="<?=$data['gambar']?>">Delete</a>
                                                <a href="detail.php?id_artikel=<?= $data['id_artikel'] ?>"
                                                    class="btn btn-info btn-sm">Detail</a>
                                                <a href="ubah.php?id_artikel=<?= $data['id_artikel'] ?>"
                                                    class="btn btn-warning btn-sm">Edit</a>
                                                <?php  if($data['status'] == 1): ?>
                                                <a href="controller.php?id_artikel=<?= $data['id_artikel'] ?>&status=<?= $data['status'] ?>&aksi=status"
