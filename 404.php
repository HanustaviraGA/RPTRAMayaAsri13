...
<head>
    ...
    <title>Ruang Publik Terpadu Ramah Anak - 404</title>
    <style>
        body {
  margin: 0;
  padding: 0;
...
<div class="notfound-copy">
  <svg aria-labelledby="404" alt="404 Halaman Tidak Ditemukan" class="not-found">
  ...
  <h1>halaman tidak ditemukan</h1>
    ...
    <p><a href="artikel/artikel.php">Artikel</a></p>
    <p><a href="kegiatan/kegiatan.php">Kegiatan</a></p>
    <p><a href="index.php#kontak-kami">Tentang Kami</a></p>
</div>
